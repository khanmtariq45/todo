My file path is C:\Users\MuhammadTariqPKDev\Downloads\Convert Data\New folder\SA07 Risk Matrix.docx  
and previous link SA07%20Consequence%20Category%20Table.pdf and new link is DocId=6EC2798F7A9C498F712EF560846A20E6  
now after my exe execution when i hover on the link it is showing me like this   
C:\Users\MuhammadTariqPKDev\Downloads\Convert Data\New folder\SA07 Risk Matrix.docx#\qms?DocId=6EC2798F7A9C498F712EF560846A20E6  
which is incorrect i just want #\qms?DocId=6EC2798F7A9C498F712EF560846A20E6  
...
def update_hyperlink_relationships(doc, old_url, new_url, para, display_text=None):  
    ...
    # Step 3: Update the raw XML field code (hover text)  
    for fldChar in para._p.iter():  
        if fldChar.tag.endswith('instrText') and old_url in fldChar.text:  
            fldChar.text = fldChar.text.replace(old_url, new_url)  
            updated = True  
